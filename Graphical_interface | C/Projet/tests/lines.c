...
void test_gitlab_fox(ei_surface_t surface, ei_rect_t* clipper1) {
	ei_linked_point_t	pts[10];
	ei_linked_point_t rect[4];
	ei_point_t p0 = { 300,300 };
	rect[0].point.x = 300;
	rect[0].point.y = 300;
	rect[0].next = &(rect[1]);
	ei_size_t size = { 100,50 };
	rect[1].point.x = 300 + size.width;
	rect[1].point.y = 300;
	rect[1].next = &(rect[2]);
	rect[2].point.x = 300 + size.width;
	rect[2].point.y = 300 + size.height;
	rect[2].next = &(rect[3]);
	rect[3].point.x = 300;
	rect[3].point.y = 300 + size.height;
	rect[3].next = NULL;
	ei_color_t cyan = { 0, 255, 255, 255 };

	ei_draw_polygon(surface, rect, cyan, NULL);
	ei_rect_t clipper = { p0,size };
	int			i, xdiff, ydiff;
	...
	ei_color_t	color1 = { 255,156,0, 128 };
	ei_color_t black = { 0,0,0,255 };

	ei_draw_polyline(surface, pts, black, NULL);
	ei_draw_polygon(surface, pts, color1, NULL);
	...
	ei_draw_polygon(surface, pts, color1, &clipper);
	...
	ei_color_t	color2 = { 255,96,0, 255 };
	...
	ei_draw_polygon(surface, pts, color2, &clipper);
...
int ei_main(int argc, char** argv)
{
	...
	/* Draw polygon */
	test_gitlab_fox(main_window, clipper_ptr);
